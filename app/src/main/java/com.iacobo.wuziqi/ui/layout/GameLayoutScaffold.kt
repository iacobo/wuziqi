...
/**
 * A scaffold component that adapts to the device orientation.
 * In portrait mode, it uses a traditional top/bottom bar layout.
 * In landscape mode, it uses a side-by-side layout with controls on one side.
 */
