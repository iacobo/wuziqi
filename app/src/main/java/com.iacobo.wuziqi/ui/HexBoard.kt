...
fun HexBoard(
    ...
    Box(
        ...
        Canvas(
            ...
            drawRect(
                color = playerOneColor.copy(alpha = 0.1f),
                topLeft = Offset(xOffset + 0.5f * hexWidth * (boardSize - 1), 
                ...
                for (col in 0 until boardSize) {
                    ...
                    if (gameState.board[row][col] != GameState.EMPTY) {
                        ...
                        drawCircle(
                            ...
                            center = Offset(centerX - hexRadius * 0.1f, centerY - hexRadius * 0.1f)
                        )
            ...
            drawLine(
                color = playerOneColor,
                strokeWidth = hexRadius * 0.2f,
                start = Offset(xOffset + 0.5f * hexWidth * (boardSize - 1), yOffset + totalHeight),
                end = Offset(xOffset + 0.5f * hexWidth * (boardSize - 1) + totalWidth, yOffset + totalHeight)
            )
