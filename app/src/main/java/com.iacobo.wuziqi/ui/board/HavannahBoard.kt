    ...
    override fun Render(
        ...
        Box(
            ...
            Canvas(
                    ...
                    .pointerInput(isGameFrozen) {
                        if (!isGameFrozen) {
                            detectTapGestures { tap ->
                                ...
                                // Using a more generous click threshold - 10% of the smaller dimension
                ...
                ) * 0.95f  // 5% additional margin for safety
                ...
                for (q in -range..range) {
                    ...
                    for (r in rMin..rMax) {
                        ...
                        val isEdge = (abs(q) == range || abs(r) == range || abs(s) == range) && !isCorner
