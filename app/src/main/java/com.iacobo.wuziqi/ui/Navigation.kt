...
fun AppNavigation(
        ...
        NavHost(
                ...
                composable(Routes.HOME) {
                        StartScreen(
                                ...
                                onNavigateToStandardGame = { opponent ->
                                        // Standard Wuziqi game (15x15 board with 5-in-a-row win
                                        // condition)
                                        ...
                                        navController.navigate(
                                                Routes.gameRoute(boardSize, winLength, isComputer)
                                        )
                                },
                ...
                composable(
                        ...
                        val boardSize =
                                backStackEntry.arguments?.getInt("boardSize")
                                        ?: GameState.DEFAULT_BOARD_SIZE
                        val winLength =
                                backStackEntry.arguments?.getInt("winLength")
                        ...
                        // We use a Route path component to ensure it only runs when the route
                        // changes
                        ...
                        LaunchedEffect(key1 = "gameSetup-$routePath") {
                                ...
                                val needsSetup =
                                        currentGame.boardSize != boardSize ||
                                                ...
                                                // Also setup new game if there's a winner (game is
                                                // complete)
                                ...
                                if (needsSetup) {
                                        ...
                                        gameViewModel.setupGame(
                                                ...
                                                winLength = winLength,
                                                opponent =
                                                        if (isComputer) Opponent.COMPUTER
                                                        else Opponent.HUMAN,
